...
derived from the op name and dtype for every test variant generated by `@ops`. These
markers require no YAML configuration — they are added dynamically at collection time.
